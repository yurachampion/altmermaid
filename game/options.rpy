...
define config.name = _("Rusalochka")
...
define config.save_directory = "Rusalochka-1726313844"
...
init -1:
    # Задаем музыку для главного меню
    $ config.main_menu_music = "audio/menu.mp3"
...
define build.itch_project = "yura-grustny/altmermaid"
